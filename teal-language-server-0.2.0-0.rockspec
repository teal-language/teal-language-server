...
build = {
   ...
   modules = {
      ...
      ["teal_language_server.build_handler.tl"] = "gen/teal_language_server/build_handler.tl.lua",
      ...
      ["teal_language_server.open_document"] = "gen/teal_language_server/open_document.lua",
